...
const services = [
    {
        ...
        icon: <FaBoxOpen className='display-2 p-3  my-3 rounded-circle p-2 footerHandshake' />,
        data_aos: 'fade',
    ...
    },
    {
        ...
        icon: <FaRecycle className='display-2 p-3  my-3 rounded-circle p-2 footerHandshake' />,
        data_aos: 'fade',
        data_aos_duration: '1000',
        data_aos_delay: '1000'
    },
    {
        ...
        icon: <FaShieldAlt className='display-2 p-3  my-3 rounded-circle p-2 footerHandshake' />,
        data_aos: 'fade',
        data_aos_duration: '1000',
        data_aos_delay: '1500'
    },
    {
        ...
        icon: <FaChartLine className='display-2 p-3  my-3 rounded-circle p-2 footerHandshake' />,
        data_aos: 'fade',
    ...
    },
    {
        ...
        icon: <FaLightbulb className='display-2 p-3  my-3 rounded-circle p-2 footerHandshake' />,
        data_aos: 'fade',
        data_aos_duration: '500',
        data_aos_delay: '1000'
    },
    {
        ...
        icon: <FaTruck className='display-2 p-3  my-3 rounded-circle p-2 footerHandshake' />,
        data_aos: 'fade',
        data_aos_duration: '500',
        data_aos_delay: '500'
    },
